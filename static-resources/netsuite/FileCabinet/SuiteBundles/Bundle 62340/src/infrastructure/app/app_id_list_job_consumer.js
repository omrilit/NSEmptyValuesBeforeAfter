 ...
 * @constructor
 */
infra.app.IdListJobConsumer = function (jobRule) {
  this.createTasklists = function (job) {
    var tasklistProducer = new infra.app.TaskListProducerFactory(jobRule).getTaskListProducer();
    var tasklistManager = new infra.app.TaskListManager();
    tasklistManager.setTaskListProducer(tasklistProducer);
    tasklistManager.createTaskLists(this.convertToView(job, jobRule));
  };
