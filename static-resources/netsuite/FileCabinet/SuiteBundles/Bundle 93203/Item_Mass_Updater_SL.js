...
function getUpdateList(content, backup_file) {
	...
	for (var i=0; item_values && i<item_values.length;i++) {
		...
		//if (!isNullOrEmpty(rec_type)) {
			...
			//col_item['item_link']='<a class="matrix_item" type="hidden" id="matrix_item_'+counter+'" is_matrix="'+matrix_item.is_matrix+'" child_size="'+matrix_item.child_count+'" include_child="false" target="_blank" href="https://system.na1.netsuite.com/app/common/item/item.nl?id='+rs[item_index].getId()+'">'+rs[item_index].getValue('itemid')+'</a>';
			col_item['item_link']='<a class="matrix_item" type="hidden" id="matrix_item_'+counter+'" include_child="false" target="_blank" href="https://system.na1.netsuite.com/app/common/item/item.nl?id='+rs[item_index].getId()+'">'+rs[item_index].getValue('itemid')+'</a>';
