...
VAT.EU.ESL.DE = VAT.EU.ESL.DE || {};

VAT.EU.ESL.DE.DataFormatter = function _DEDataFormatter() {
    VAT.EU.BaseDataFormatter.call(this);
};
VAT.EU.ESL.DE.DataFormatter.prototype = Object.create(VAT.EU.BaseDataFormatter.prototype);

VAT.EU.ESL.DE.DataFormatter.prototype.formatData = function _formatData() {
    try {
        this.setColumnProperty('align');
        this.setDecimalPlaces(0, 'amount');
    } catch (e) {
        logException(e, 'VAT.EU.ESL.DE.DataFormatter.formatData');
        throw e;
    }
};

VAT.EU.ESL.DE.Report = function _DEReport(baseDetails, countryDetails) {
    if (!baseDetails) {
    ...
    try {
        ...
        logException(e, 'VAT.EU.ESL.DE.Report');
        throw e;
    }
};
VAT.EU.ESL.DE.Report.prototype = Object.create(VAT.EU.ESL.BaseReport.prototype);

VAT.EU.ESL.DE.DataAdapter = function _DEDataAdapter() {
    VAT.EU.ESL.Adapter.SalesReportAdapter.call(this);
};
VAT.EU.ESL.DE.DataAdapter.prototype = Object.create(VAT.EU.ESL.Adapter.SalesReportAdapter.prototype);

VAT.EU.ESL.DE.DataAdapter.prototype.traverseAndConsolidate = function _traverseAndConsolidate(rawTreeKey) {
    if (!rawTreeKey) {
    ...
    try {
        ...
        logException(e, 'VAT.EU.ESL.DE.DataAdapter.traverseAndConsolidate');
        throw e;
    }
};

VAT.EU.ESL.DE.DataAdapter.prototype.createDataRows = function _createDataRows(currentNode, countryNode, countryCode, lineNumber) {
    if (!currentNode) {
