...
Tax.EU.Intrastat.DAO.IntrastatGenericPurchaseDAO = function IntrastatGenericPurchaseDAO() {
    VAT.EU.DAO.SavedReportDAO.call(this);
    this.daoName = 'IntrastatGenericPurchaseDAO';
    this.reportName = 'Intrastat Generic Purchase Report[4873]';
};

Tax.EU.Intrastat.DAO.IntrastatGenericPurchaseDAO.prototype = Object.create(VAT.EU.DAO.SavedReportDAO.prototype);

Tax.EU.Intrastat.DAO.IntrastatGenericPurchaseDAO.prototype.ListObject = function ListObject() {
    return {
        entity:'',
        vatNo:'',
        projectVatNo:'',
...
Tax.EU.Intrastat.DAO.IntrastatGenericPurchaseDAO.prototype.rowToObject = function rowToObject(pivotReport) {
    try {
        ...
        logException(ex, 'Tax.EU.Intrastat.DAO.IntrastatGenericPurchaseDAO.rowToObject');
        throw ex;
    }
...
Tax.EU.Intrastat.DAO.IntrastatGenericPurchaseDAO.prototype.extractRows = function extractRows(node, columns) {
...
Tax.EU.Intrastat.DAO.IntrastatGenericPurchaseDAO.prototype.getColumnMetadata = function getColumnMetadata(pivotReport) {
