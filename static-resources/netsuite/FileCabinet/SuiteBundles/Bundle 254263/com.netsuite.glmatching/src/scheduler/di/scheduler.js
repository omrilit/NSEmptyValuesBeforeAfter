...
define(["exports", "N/log", "N/record", "N/search", "N/task", "../Scheduler"], function (_exports, nLog, nRecord, nSearch, nTask, _Scheduler) {
  "use strict";
  ...
  var scheduler = new _Scheduler.Scheduler(nRecord, nSearch, nTask, nLog);
