...
Ext4.onReady(function() {
    ...
    if (Ext4.Updater) {
        Ext4.Updater.defaults.indicatorText = '<div class="loading-indicator">Cargando...</div>';
    }

    if (Ext4.Date) {
        Ext4.Date.monthNames = ["Enero", "Febrero", "Marzo", "Abril", "Mayo", "Junio", "Julio", "Agosto", "Septiembre", "Octubre", "Noviembre", "Diciembre"];
        ...
        Ext4.Date.dayNames = ["Domingo", "Lunes", "Martes", "Miércoles", "Jueves", "Viernes", "Sábado"];
...
Ext4.define("Ext4.locale.es.view.View", {
    override: "Ext4.view.View",
    emptyText: ""
});

Ext4.define("Ext4.locale.es.grid.plugin.DragDrop", {
    override: "Ext4.grid.plugin.DragDrop",
    dragText: "{0} fila(s) seleccionada(s)"
});

// changing the msg text below will affect the LoadMask
Ext4.define("Ext4.locale.es.view.AbstractView", {
    override: "Ext4.view.AbstractView",
    msg: "Cargando..."
});

Ext4.define("Ext4.locale.es.picker.Date", {
...
Ext4.define("Ext4.locale.es.picker.Month", {
    override: "Ext4.picker.Month",
    okText: "&#160;Aceptar&#160;",
    cancelText: "Cancelar"
});

Ext4.define("Ext4.locale.es.toolbar.Paging", {
...
Ext4.define("Ext4.locale.es.form.field.Base", {
    override: "Ext4.form.field.Base",
    invalidText: "El valor en este campo es inválido"
});

Ext4.define("Ext4.locale.es.form.field.Text", {
...
Ext4.define("Ext4.locale.es.form.field.Number", {
...
Ext4.define("Ext4.locale.es.form.field.File", { 
    override: "Ext4.form.field.File", 
    buttonText: "Examinar..." 
});

Ext4.define("Ext4.locale.es.form.field.Date", {
...
Ext4.define("Ext4.locale.es.form.field.ComboBox", {
...
Ext4.define("Ext4.locale.es.form.field.HtmlEditor", {
...
Ext4.define("Ext4.locale.es.grid.header.Container", {
...
Ext4.define("Ext4.locale.es.grid.GroupingFeature", {
...
Ext4.define("Ext4.locale.es.grid.PropertyColumnModel", {
...
Ext4.define("Ext4.locale.es.form.field.Time", {
