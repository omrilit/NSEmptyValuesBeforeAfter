...
Ext4.onReady(function() {
    ...
    if (Ext4.MessageBox) {
        ...
        Ext4.MessageBox.msgButtons['ok'].text = Ext4.MessageBox.buttonText.ok;
        Ext4.MessageBox.msgButtons['cancel'].text = Ext4.MessageBox.buttonText.cancel;
        Ext4.MessageBox.msgButtons['yes'].text = Ext4.MessageBox.buttonText.yes;
        Ext4.MessageBox.msgButtons['no'].text = Ext4.MessageBox.buttonText.no;
    }
