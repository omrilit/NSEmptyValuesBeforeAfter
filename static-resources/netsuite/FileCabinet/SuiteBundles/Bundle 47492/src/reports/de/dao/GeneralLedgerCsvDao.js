...
TAF.DE.DAO.GeneralLedgerCsvDao = function _GeneralLedger(textFileDaoParam) {
    ...
    this.transformMap = {
    		'posting' : function(param){return param === 'Yes' ? 'T' : 'F'},
    };
    this.validationMap = {};
    this.container = function(){
    	return new TAF.DE.DAO.GeneralLedgerLine()
    	};
...
TAF.DE.DAO.GeneralLedgerCsvDao.prototype = Object.create(TAF.DAO.CsvDAO.prototype);

TAF.DE.DAO.GeneralLedgerCsvDao.prototype.getList = function _getList(resStartIdx, resEndIdx, fileStartIdx){
...
TAF.DE.DAO.GeneralLedgerCsvDao.prototype.getCurrentIndex = function _getFileIndex(){
