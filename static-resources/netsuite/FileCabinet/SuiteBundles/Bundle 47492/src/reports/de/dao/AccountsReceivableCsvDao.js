...
TAF.DE.DAO.AccountsReceivableCsvDao = function _AccountsReceivable(textFileDaoParam) {
    ...
    this.columnMap = {
    		...
    		'Type' : 'type',
    		'custId' : 'customerEntityId',
    		'custIsIndvidual' : 'customerIsPerson',
    		'custFirstName' : 'customerFirstName',
    		'custLastName' : 'customerLastName',
    		'custCoName' : 'customerCompanyName',
    };    
    ...
    this.transformMap = {
    		'customerIsPerson' : function(param){return param === 'Yes' ? 'T' : 'F'},
    		};
    this.validationMap = {};    
    this.container = function(){
    	return new TAF.DE.DAO.AccountsReceivableLine()
    	};
    this.currentIndex = {
    		rowFile:0,
    		file: 0
...
TAF.DE.DAO.AccountsReceivableCsvDao.prototype = Object.create(TAF.DAO.CsvDAO.prototype);

TAF.DE.DAO.AccountsReceivableCsvDao.prototype.getList = function _getList(resStartIdx, resEndIdx, fileStartIdx){
...
TAF.DE.DAO.AccountsReceivableCsvDao.prototype.getCurrentIndex = function _getFileIndex(){
