...
function PH_CRJ_Report(state, params, output, job)
{
    ...
    function __AuditFile()
    {
        ...
        function _OnHeader()
        {
        	_Output.WriteLine('Cash Receipts Journal\n');
        ...
        function _GetFileName()
        {
            ...
            var reportName = 'CashReceiptsJournal';
        ...
        function _GetSearchFilters()
        {
            var filters = [
                ...
                new SuiteScript.nlobjSearchFilter('type', null, 'anyof', ['CustPymt', 'CashSale', 'CustDep'])
            ];
        ...
        function _PopulateColumns(row) {
            ...
            line.push('\"' + row.getValue('memomain') + '\"');
...
PH_CRJ_Report.IsCRGReport = true;
PH_CRJ_Report.ReportId = 'PH_CRJ_CSV';
