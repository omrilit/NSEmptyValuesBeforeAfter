...
TAF.CS.OnFieldChanged = function _OnFieldChanged(type, name, line) {
    if (name === 'custrecord_income_stat_1175_grouping_cod') {
        var standardAccountId = nlapiGetFieldValue('custrecord_income_stat_1175_grouping_cod');
...
TAF.CS.SaveRecord = function _SaveRecord(){
    var standardAccountId = nlapiGetFieldValue('custrecord_income_stat_1175_grouping_cod');
    var standardAccountDes = nlapiGetFieldValue('custrecord_income_stat_1175_grouping_des');
